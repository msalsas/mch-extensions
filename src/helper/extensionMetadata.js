    ...
    try {
      ...
      fetch(url)
        ...
        .then((data) => {
          ...
          const { lv, hp, phy, int, agi, rarity, total_volume, transfer, type_name, volume } = attributes;
          const { extension_type, alias, art, art_image_url, default_image_url } = extra_data;
          ...
          const metadata = {
            ...
            'extension_url': 'https://www.mycryptoheroes.net/dictionary/extensions/' + extension_type,
            'alias': alias,
            'art': art,
